...
const Dashobard = () => {
  return (
    <div>
      ...
      {/* main */}
      <main className="container max-w-5xl mx-auto grid grid-cols-2 pt-20 " >
        <div >
      ...
      <alur class="text-center mt-10">
        <p class="mb-4 font-normal text-2xl text-black lg:text-xl sm:px-16 xl:px-48">Tata Cara Pendaftaran </p>
        <p class="mb-16 font-normal text-2xl text-black lg:text-xl sm:px-16 xl:px-48">Magang Diskominfo Kota Semarang</p>
      </alur>
      ...
      <div class="text-center mt-20">
        <p class="mb-4 font-normal text-2xl text-black lg:text-xl sm:px-16 xl:px-48">Dashboard Magang Diskominfo  </p>
        <p class="mb-16 font-normal text-2xl text-black lg:text-xl sm:px-16 xl:px-48">Kota Semarang</p>
      </div>
      <div>
      ...
      <div>
        <div class="text-center mt-10">
          <p class="mb-4 font-normal text-2xl text-black lg:text-xl sm:px-16 xl:px-48">Apa yang kamu dapatkan di magang  </p>
          <p class="mb-16 font-normal text-2xl text-black lg:text-xl sm:px-16 xl:px-48">Diskominfo Kota Semarang</p>
        </div>
      </div>
      <div>
        <div class="flex flex-row gap-4 md:gap-10 lg:gap-10 p-9 ml-28 mr-28 items-center justify-center pb-5">
          ...
          <div class="flex flex-col items-center">
            ...
            <span class="mt-5 text-gray-700 text-center">Sertifikat Magang yang di tanda tangani oleh sopo yo</span>
          </div>
          <div class="flex flex-col items-center">
            <div class="w-20 h-20 bg-red-500 shadow-xl rounded-full flex justify-center items-center">
              <span class="text-white font-bold text-2xl">4</span>
      ...
      <div class="text-center mt-20">
        <p class="mb-4 font-normal text-2xl text-black lg:text-xl sm:px-16 xl:px-48">Pertanyaan yang paling sering ditanyakan</p>
      </div>
      <div>
        <div class="flex flex-col gap-4 text-center ">
          <div class="bg-gray-200  p-4 rounded-md shadow">Kotak 1</div>
          <div class="bg-gray-200 p-4 rounded-md shadow">Kotak 2</div>
          <div class="bg-gray-200 p-4 rounded-md shadow">Kotak 3</div>
          <div class="bg-gray-200 p-4 rounded-md shadow">Kotak 4</div>
